...
export default function ClientTimesheets() {
    ...
    const statusPill = (status) => {
        ...
        return (
            <span className={`px-4 py-1 rounded-full text-[9px] font-black uppercase tracking-widest border ${cls}`}>
                {s || "—"}
            </span>
        );
    };
        ...
        <>
            <div className="flex h-screen w-screen bg-bg-slate flex-col md:flex-row overflow-hidden relative">
                ...
                <main className="flex-1 flex flex-col h-full overflow-hidden">
                    <header className="bg-white py-4 px-4 md:px-6 flex flex-wrap items-center justify-between gap-3 shadow-sm z-10 border-b border-[#E3E8EF] w-full">
                        <div>
