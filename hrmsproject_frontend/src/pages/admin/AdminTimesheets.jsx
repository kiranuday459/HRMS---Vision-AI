                            ...
                            <>
                                <div className="sticky top-0 z-20 bg-white rounded-[24px] p-3 shadow-xl border border-brand-blue/5 flex flex-nowrap items-center gap-2.5 overflow-hidden mb-6">
                                    ...
                                    <div className="flex items-center gap-1.5 shrink-0">
                                        <label htmlFor="admin-role-filter" className="text-[10px] font-black uppercase tracking-[0.15em] text-brand-text/50">Roles</label>
                                        <select
                                            ...
                                            className="h-9 rounded-2xl border border-brand-blue/10 bg-white px-3 text-xs font-bold text-brand-text outline-none focus:ring-2 focus:ring-brand-blue/5 shadow-sm cursor-pointer hover:border-brand-blue/30 transition-all"
                                        >
                                    ...
                                    <div className="flex items-center gap-1.5 shrink-0">
                                        <label htmlFor="admin-status-filter" className="text-[10px] font-black uppercase tracking-[0.15em] text-brand-text/50">Status</label>
                                        <select
